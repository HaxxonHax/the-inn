 ...
 * @param {string}      actorActingAs  The name of the actor paying Gold.
 * @param {string}      userIDActingAs The name of the actor or game to which the actor is sending Gold .
