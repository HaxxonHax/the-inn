 ...
 * @param {string}      actorActingAsName  The name of the actor that is requesting the deal.
...
if (args.length < 2) {
  ...
  console.log(`${gameName} | Requires: dealCardAsActor(fromDeckName, toDeckName, chatText, actorActingAsName, toTop, numCards);`);
