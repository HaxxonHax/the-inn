 ...
 * @param {string}      userIDActingAs The id of the user that is requesting the deal.
 * @param {int}         numCards       The number of cards to deal.
 */
// dealCardAsActor(actorActingAs, userIDActingAs, chatText, actorActingAs, userIdActingAs)
...
if (args.length < 2) {
  ...
  console.log(`[${gameName}] Requires: dealCardAsActor(actorActingAs, userIDActingAs, chatText, actorActingAs, userIdActingAs);`);
  ...
  console.log(`numCards "${numCards.toString()}"`);
